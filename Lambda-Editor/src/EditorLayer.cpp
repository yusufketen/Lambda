...
namespace Lambda {
	...
	void EditorLayer::OnAttach()
	{
		...
		Lambda::FramebufferSpecification fbSpec;
		fbSpec.Width = 1280;
		fbSpec.Height = 720;
		m_Framebuffer = Lambda::Framebuffer::Create(fbSpec);
	}
	...
	void EditorLayer::OnUpdate(Lambda::Timestep ts)
	{
		LM_PROFILE_FUNCTION();
...

		{
			...
			Lambda::Renderer2D::DrawQuad({ 0.5f, -0.5f }, { 0.5f, 0.75f }, m_SquareColor);
	...
	void EditorLayer::OnImGuiRender()
	{
		...
		if (ImGui::BeginMenuBar())
		{
			if (ImGui::BeginMenu("File"))
			{
				...
				if (ImGui::MenuItem("Exit")) Lambda::Application::Get().Close();
				ImGui::EndMenu();
			}
	...
	void EditorLayer::OnEvent(Lambda::Event& e)
	{
